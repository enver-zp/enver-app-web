...
export default function App() {
  ...
  // YENİ: Bildirim İstemi Simülasyonu
        ...
        <div className="bg-gradient-to-br from-gray-50 via-gray-100 to-red-50 min-h-screen pb-24 font-sans text-gray-900 select-none overflow-x-hidden text-black" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd} onContextMenu={preventActions}>
          ...
          <header className="bg-white px-4 h-16 flex items-center justify-between sticky top-0 z-[100] shadow-sm border-b border-gray-100 text-black">
            ...
            <div className="flex items-center gap-4">
              ...
              <div onClick={() => setSelectedImage('/enver-profil.png')} className="w-10 h-10 rounded-full border-2 border-red-600 overflow-hidden bg-gray-200 shadow-md cursor-pointer active:scale-90 transition-transform">
            ...
            {activeTab === 'home' && (
              <div className="animate-in fade-in duration-500 pb-10">
                <div className="p-4 pt-6">
                    {/* Header Image */}
                    <div onClick={() => setSelectedImage('/enver-kapak.png')} className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 relative overflow-hidden h-[280px] cursor-pointer active:scale-95 transition-transform border-2 border-red-100">
